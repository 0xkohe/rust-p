...
fn single_threaded() {
    ...
    println!("Single threaded: {}.{:03}", end.as_secs(), end.subsec_nanos());
}
...
fn multi_threaded() {
    ...
    let end = start.elapsed();
    println!("Multi threaded: {}.{:03}", end.as_secs(), end.subsec_nanos());
}
